...
from ..shared import branchresponse as shared_branchresponse
from ..shared import generalerror as shared_generalerror
from typing import Optional


@dataclasses.dataclass
class GetProjectBranchRequest:
...
@dataclasses.dataclass
class GetProjectBranchResponse:
    
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    branch_response: Optional[shared_branchresponse.BranchResponse] = dataclasses.field(default=None)

...
from ..shared import databasecreaterequest as shared_databasecreaterequest
...
class CreateProjectBranchDatabaseRequest:
    
    branch_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'branch_id', 'style': 'simple', 'explode': False }})
    r"""The branch ID"""
    database_create_request: shared_databasecreaterequest.DatabaseCreateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    project_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'project_id', 'style': 'simple', 'explode': False }})
    r"""The Neon project ID"""
    

@dataclasses.dataclass
class CreateProjectBranchDatabaseResponse:

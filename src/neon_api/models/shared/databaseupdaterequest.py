...
class DatabaseUpdateRequestDatabase:
...
class DatabaseUpdateRequest:
    database: DatabaseUpdateRequestDatabase = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('database') }})
